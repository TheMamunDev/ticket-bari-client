  ...
  return (
    <div className="bg-neutral text-neutral-content">
      <footer className=" max-w-7xl mx-auto py-10 ">
        <div className=" footer max-w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <aside>
        ...
        <div className="footer flex flex-col md:flex-row justify-between items-center mt-3 pt-3  max-w-11/12 mx-auto text-neutral-content border-t border-gray-700">
          <aside>
            <p className="text-sm">
